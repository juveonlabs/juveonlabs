    ...
    <div className="min-h-screen w-full font-display selection:bg-blue-500/30 bg-[#faf9fc] relative overflow-hidden flex flex-col items-center">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 lg:px-8 pt-8 pb-16 lg:pt-12 lg:pb-24 flex flex-col flex-1">
        ...
        <div className="mb-16 opacity-0 translate-y-8 animate-[fade-in-up_0.8s_ease-out_forwards]">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-white flex items-center justify-center shadow-sm border border-blue-100/60 mb-6">
        ...
        <div className="prose prose-lg prose-blue max-w-none text-gray-600 space-y-8 opacity-0 translate-y-8 animate-[fade-in-up_0.8s_ease-out_forwards]" style={{ animationDelay: '200ms' }}>
          ...
          <section className="bg-white/80 backdrop-blur-3xl border border-gray-200/60 rounded-3xl p-8 shadow-sm">
            ...
            <a href="mailto:juveonlabs@gmail.com" className="font-bold text-blue-600 hover:text-blue-700 transition-colors">juveonlabs@gmail.com</a>
          </section>
