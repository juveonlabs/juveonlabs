    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <div className="hidden lg:flex absolute left-8 top-1/2 -translate-y-1/2 items-end gap-1.5 h-40 opacity-30">
        {[...Array(45)].map((_, i) => (
          <div
            key={i}
            className="w-1 bg-gradient-to-t from-blue-600 to-indigo-400 rounded-full animate-spectrum"
      ...
      <div className="hidden lg:flex absolute right-8 top-1/2 -translate-y-1/2 items-end gap-1.5 h-40 opacity-30">
        {[...Array(45)].map((_, i) => (
          <div
            key={i}
            className="w-1 bg-gradient-to-t from-indigo-600 to-blue-400 rounded-full animate-spectrum"
      ...
      {/* Floating 3D Rings */}
      <div className="absolute left-[-5%] top-1/4 w-[500px] h-[500px] border-[1px] border-blue-200/40 rounded-full animate-float-3d opacity-40 mix-blend-multiply" />
      ...
      <div className="absolute left-1/3 top-[-10%] w-[400px] h-[400px] border-[1px] border-sky-200/20 rounded-full animate-float-3d opacity-20 mix-blend-multiply" style={{ animationDelay: '-10s' }} />
    </div>
  );
};
  ...
  >
    {imgSrc ? (
      ...
      <>
        ...
        <div className="absolute -bottom-8 -right-8 w-32 h-32 bg-blue-200/50 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
      </>
    )}
  </div>
);
...
export default function App() {
  ...
  return (
    <main className="w-full font-display selection:bg-blue-500/30">
      {/* HERO SECTION */}
            ...
            <div className="flex flex-col h-full w-full px-6 py-2 lg:px-10 lg:py-4 justify-between relative mt-1 lg:mt-2">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <img src="/Frame 4.png" alt="Juveon Labs Logo - AI Integration Experts" className="h-8 md:h-10 w-auto object-contain" />
                  <span className="font-semibold text-2xl tracking-tighter text-gray-900">juveon labs</span>
                </div>
                <div className="flex items-center gap-4 lg:gap-6">
                  <button onClick={() => navigate('/about')} className="text-sm font-semibold text-gray-600 hover:text-blue-600 transition-colors hidden md:block">
                    About Us
                  </button>
                  <div className="hidden lg:flex items-center gap-2">
                    <a href="https://www.linkedin.com/company/juveonlabs/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 hover:bg-blue-100 transition-colors">
                      <Linkedin size={14} />
                    </a>
                    <a href="https://www.instagram.com/juveonlabs?igsh=MWdud2dwNzBmYm1vcw%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 hover:bg-blue-100 transition-colors">
                      <Instagram size={14} />
                    </a>
                  </div>
                  <a
                    ...
                    className="px-5 py-2 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold text-xs shadow-md hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-300 flex items-center justify-center"
                  >
                    Book a Call
                  </a>
                </div>
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center max-w-2xl mx-auto space-y-8 mt-12 mb-12">
                <div className="bg-gradient-to-r from-blue-100 to-indigo-100 border border-blue-200/60 px-5 py-2 rounded-full mb-6 flex items-center gap-2 shadow-sm">
                  <Sparkles size={14} className="text-blue-600" />
                  <span className="text-[11px] font-bold tracking-[0.2em] text-blue-700 uppercase">AI AGENTS · BUILT FOR YOUR BUSINESS</span>
                </div>
                ...
                <h1 className="text-4xl lg:text-5xl font-medium tracking-[-0.03em] text-gray-900 leading-[1.2]">
                  ...
                  <span className="font-serif italic text-blue-600 text-2xl lg:text-3xl mt-2 inline-block">Then we automate it.</span>
                </h1>

                <button
                  onClick={() => document.getElementById('services')?.scrollIntoView({ behavior: 'smooth' })}
                  className="rounded-full pl-6 pr-2 py-2 flex items-center gap-4 hover:scale-105 active:scale-95 transition-transform mt-4 bg-gradient-to-r from-blue-600 to-indigo-600 shadow-[0_10px_40px_-10px_rgba(109,40,217,0.5)]"
                >
                ...
                <div className="flex flex-wrap justify-center gap-3 mt-8">
                  {['Workflow Audits', 'Custom AI Dev', 'Ecosystem Integration'].map((pill) => (
                    <div key={pill} className="rounded-full px-4 py-2 text-xs text-blue-700 font-medium bg-blue-50 border border-blue-100 hover:bg-blue-100 transition-colors cursor-pointer">
                      {pill}
                    </div>
                  ))}
                </div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
              <h2 className="text-sm font-bold tracking-widest text-blue-600 uppercase mb-3">Our Services</h2>
              <h3 className="text-4xl md:text-5xl lg:text-5xl font-bold tracking-tight text-gray-900 leading-tight mb-4">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Smarter Operations.</span>
              </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            <ScrollReveal delay={0}>
              <div onClick={() => navigate('/agents')} className="group relative rounded-[2rem] p-[2px] shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_20px_50px_-12px_rgba(147,51,234,0.25)] hover:-translate-y-2 transition-all duration-700 cursor-pointer overflow-hidden">
                <div className="absolute inset-[-100%] animate-[spin_10s_linear_infinite] bg-[conic-gradient(from_0deg,transparent_60%,#3b82f6_85%,#1e3a8a_100%)] opacity-30 group-hover:opacity-100 transition-opacity duration-1000" />
                <div className="relative h-full bg-white/90 backdrop-blur-2xl border border-white/50 group-hover:border-transparent rounded-[1.9rem] p-6 lg:p-8 overflow-hidden transition-colors duration-700">
                  ...
                  <div className="relative z-10">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-50 to-white flex items-center justify-center mb-6 shadow-sm border border-blue-100/60 group-hover:border-blue-500 group-hover:from-blue-600 group-hover:to-blue-500 group-hover:rotate-3 group-hover:scale-110 transition-all duration-500">
                      <Wand2 size={24} strokeWidth={1.5} className="text-blue-600 group-hover:text-white transition-colors duration-500" />
                    </div>
                    ...
                    <div className="flex items-center gap-2 text-blue-700 font-semibold group-hover:gap-4 transition-all duration-300 text-sm md:text-base">
            ...
            <ScrollReveal delay={300}>
              <div onClick={() => navigate('/call-agents')} className="group relative rounded-[2rem] p-[2px] shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_20px_50px_-12px_rgba(217,70,239,0.25)] hover:-translate-y-2 transition-all duration-700 cursor-pointer overflow-hidden">
                ...
                <div className="relative h-full bg-white/90 backdrop-blur-2xl border border-white/50 group-hover:border-transparent rounded-[1.9rem] p-6 lg:p-8 overflow-hidden transition-colors duration-700">
                  ...
                  <div className="relative z-10">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-sky-50 to-white flex items-center justify-center mb-6 shadow-sm border border-sky-100/60 group-hover:border-sky-500 group-hover:from-sky-600 group-hover:to-sky-500 group-hover:rotate-3 group-hover:scale-110 transition-all duration-500">
                      <Bot size={24} strokeWidth={1.5} className="text-sky-600 group-hover:text-white transition-colors duration-500" />
                    </div>
                    ...
                    <div className="flex items-center gap-2 text-sky-700 font-semibold group-hover:gap-4 transition-all duration-300 text-sm md:text-base">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <ScrollReveal>
            ...
            <div className="text-center max-w-3xl mx-auto mb-20">
              <h2 className="text-sm font-bold tracking-widest text-blue-600 uppercase mb-4">What JuveonLabs Does</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <ScrollReveal delay={0}>
              <div className="relative rounded-[2rem] p-[2px] overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.06)]">
                <div className="absolute inset-[-100%] animate-[spin_12s_linear_infinite] bg-[conic-gradient(from_0deg,transparent_65%,#3b82f6_88%,#2563eb_100%)] opacity-30" />
      ...
      <section className="relative w-full py-16 lg:py-20 bg-[#faf9fc] overflow-hidden border-t border-blue-50">
        <div className="absolute inset-0 pointer-events-none opacity-[0.15] z-0" style={{ backgroundImage: 'radial-gradient(#2563eb 1.5px, transparent 1.5px)', backgroundSize: '24px 24px' }} />

        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-10 md:mb-12">
              <h2 className="text-xs font-bold tracking-[0.2em] text-blue-600 uppercase mb-3">Proven Impact</h2>
            ...
            <div className="relative w-full max-w-4xl mx-auto rounded-[2rem] bg-white/95 backdrop-blur-3xl border border-gray-200 shadow-sm p-8 lg:p-12 flex flex-col items-center text-center overflow-hidden group hover:shadow-md transition-shadow duration-500 hover:shadow-[0_20px_40px_-15px_rgba(79,70,229,0.15)]">
              <div className="relative z-10 max-w-2xl w-full mx-auto">
                <h3 className="text-2xl md:text-3xl font-bold tracking-tight mb-3 leading-tight text-gray-900">Your business could be <span className="text-blue-600">running smarter.</span></h3>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-gray-900 text-white px-6 py-3 rounded-full font-bold text-sm hover:shadow-[0_10px_20px_-10px_rgba(17,24,39,0.4)] hover:-translate-y-0.5 active:scale-95 transition-all duration-300"
                >
      ...
      {/* TEAM SECTION */}
      <section className="relative w-full py-24 bg-[#faf9fc] overflow-hidden border-t border-blue-50">
        {/* Dotted Spectrum Background Layer */}
        <div className="absolute inset-0 pointer-events-none opacity-[0.15] z-0" style={{ backgroundImage: 'radial-gradient(#2563eb 1.5px, transparent 1.5px)', backgroundSize: '24px 24px' }} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 max-w-4xl mx-auto">
              <div className="group cursor-pointer">
                ...
                <div className="mt-6 text-center">
                  <h4 className="text-xl font-bold text-gray-900 group-hover:text-blue-600 transition-colors">James Prabhakar</h4>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                ...
                <div className="mt-6 text-center">
                  <h4 className="text-xl font-bold text-gray-900 group-hover:text-blue-600 transition-colors">Uttej Kumar</h4>
                </div>
              </div>

              <div className="group cursor-pointer">
                <ImagePlaceholder label="Vignan" imgSrc="/Vig.PNG" />
                <div className="mt-6 text-center">
                  <h4 className="text-xl font-bold text-gray-900 group-hover:text-blue-600 transition-colors">Vignan Thumma</h4>
                </div>
              </div>
            </div>
          </ScrollReveal>
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center mb-8">
              <h2 className="text-xs font-bold tracking-widest text-blue-600 uppercase mb-3">Get In Touch</h2>
            ...
            <div className="relative rounded-[1.6rem] p-[2px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden group">
              <div className="absolute inset-[-100%] animate-[spin_10s_linear_infinite] bg-[conic-gradient(from_0deg,transparent_60%,#3b82f6_85%,#1e3a8a_100%)] opacity-20 group-hover:opacity-60 transition-opacity duration-700" />
              <form onSubmit={handleContactSubmit} className="relative h-full bg-white/95 backdrop-blur-3xl border border-white/50 rounded-[1.5rem] p-6 lg:p-8 overflow-hidden flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input type="text" name="name" required placeholder="Jane Doe" className="w-full px-4 py-3 rounded-xl bg-gray-50/80 border border-gray-200/80 focus:bg-white focus:outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-500/10 transition-all font-medium text-gray-900 placeholder-gray-400 text-sm" />
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[11px] font-bold uppercase tracking-wider text-gray-500 ml-1">Email Address</label>
                    <input type="email" name="email" required placeholder="jane@company.com" className="w-full px-4 py-3 rounded-xl bg-gray-50/80 border border-gray-200/80 focus:bg-white focus:outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-500/10 transition-all font-medium text-gray-900 placeholder-gray-400 text-sm" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input type="text" name="company" placeholder="Acme Corp" className="w-full px-4 py-3 rounded-xl bg-gray-50/80 border border-gray-200/80 focus:bg-white focus:outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-500/10 transition-all font-medium text-gray-900 placeholder-gray-400 text-sm" />
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[11px] font-bold uppercase tracking-wider text-gray-500 ml-1">Phone Number</label>
                    <input type="tel" name="phone" placeholder="+1 (555) 000-0000" className="w-full px-4 py-3 rounded-xl bg-gray-50/80 border border-gray-200/80 focus:bg-white focus:outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-500/10 transition-all font-medium text-gray-900 placeholder-gray-400 text-sm" />
                  </div>
                </div>

                <div className="flex flex-col gap-1.5">
                  <label className="text-[11px] font-bold uppercase tracking-wider text-gray-500 ml-1">What are you interested in?</label>
                  <select name="service_interest" required defaultValue="" className="w-full px-4 py-3 rounded-xl bg-gray-50/80 border border-gray-200/80 focus:bg-white focus:outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-500/10 transition-all font-medium text-gray-900 cursor-pointer text-sm">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea name="message" required rows="3" placeholder="Tell us about the workflows you want to automate..." className="w-full px-4 py-3 rounded-xl bg-gray-50/80 border border-gray-200/80 focus:bg-white focus:outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-500/10 transition-all resize-none font-medium text-gray-900 placeholder-gray-400 text-sm"></textarea>
                </div>

                <button type="submit" disabled={formStatus === 'Sending...'} className="mt-2 w-full py-3 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold text-base shadow-[0_10px_40px_-10px_rgba(109,40,217,0.5)] hover:shadow-[0_15px_50px_-10px_rgba(109,40,217,0.7)] hover:scale-[1.01] active:scale-[0.99] transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed">
