...
export default function About() {
  ...
  return (
    <main className="min-h-screen w-full font-display selection:bg-blue-500/30 bg-[#faf9fc] relative overflow-hidden flex flex-col items-center">
      {/* Background Decor */}
      ...
      <div className="relative z-10 w-full max-w-7xl px-6 lg:px-8 pt-8 pb-16 lg:pt-12 lg:pb-24 flex flex-col flex-1">
        ...
        <div className="mb-24 mt-8 opacity-0 translate-y-8 animate-[fade-in-up_0.8s_ease-out_forwards]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-sm font-bold tracking-widest text-blue-600 uppercase mb-4">Our Story</h2>
              <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-gray-900 leading-[1.1] mb-6">
                Built to elevate <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">human potential.</span>
              </h1>
              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full border border-blue-100 bg-blue-50 flex items-center justify-center shrink-0">
            ...
            <div className="relative h-[500px] w-full rounded-[3rem] p-[2px] overflow-hidden group shadow-[0_20px_50px_-12px_rgba(147,51,234,0.15)] hidden lg:block">
              <div className="absolute inset-[-100%] animate-[spin_12s_linear_infinite] bg-[conic-gradient(from_0deg,transparent_60%,#3b82f6_85%,#1e3a8a_100%)] opacity-20" />
              <div className="relative h-full bg-white/60 backdrop-blur-xl border border-white/50 rounded-[2.9rem] overflow-hidden flex items-center justify-center p-8">
                <div className="w-full h-full border border-blue-200/50 rounded-[2rem] bg-gradient-to-br from-blue-50/50 to-white/30 flex flex-col items-center justify-center text-center relative overflow-hidden">
                  <Shield size={64} strokeWidth={1} className="text-blue-300 mb-6" />
                  <p className="text-sm tracking-widest uppercase font-bold text-gray-400">Juveon Labs Intelligence</p>
                  {/* Decorative moving blur */}
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] bg-gradient-to-br from-blue-400/10 to-transparent rounded-full animate-[spin_8s_linear_infinite] pointer-events-none mix-blend-multiply" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="group cursor-pointer">
              ...
              <div className="mt-6 text-center">
                <h4 className="text-lg font-bold text-gray-900 group-hover:text-blue-600 transition-colors">James Prabhakar</h4>
              </div>
            </div>
            ...
            <div className="group cursor-pointer">
              ...
              <div className="mt-6 text-center">
                <h4 className="text-lg font-bold text-gray-900 group-hover:text-blue-600 transition-colors">Uttej Kumar</h4>
              </div>
            </div>
            ...
            <div className="group cursor-pointer">
              ...
              <div className="mt-6 text-center">
                <h4 className="text-lg font-bold text-gray-900 group-hover:text-blue-600 transition-colors">Vignan Thumma</h4>
              </div>
            </div>
