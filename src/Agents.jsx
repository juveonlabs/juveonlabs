...
export default function Agents() {
  ...
  return (
    <div className="min-h-screen w-full font-display selection:bg-blue-500/30 bg-[#faf9fc] relative overflow-hidden flex flex-col items-center">
      ...
      <div className="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-blue-200/40 rounded-full blur-3xl opacity-30 mix-blend-multiply pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-7xl px-6 lg:px-8 pt-8 pb-16 lg:pt-12 lg:pb-24 flex flex-col flex-1">
        ...
        <div className="mb-20 text-center max-w-3xl mx-auto opacity-0 translate-y-8 animate-[fade-in-up_0.8s_ease-out_forwards]">
          <h2 className="text-sm font-bold tracking-widest text-blue-600 uppercase mb-4">Core Capabilities</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <AgentCard 
            ...
            gradientClass="bg-[conic-gradient(from_0deg,transparent_60%,#3b82f6_85%,#1e3a8a_100%)]"
            delay="100ms"
          />
          <AgentCard 
            icon={Workflow}
          ...
          <AgentCard 
            ...
            colorClass="from-sky-500/[0.04] to-transparent"
