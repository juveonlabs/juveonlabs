...
const Connector = ({ vertical = false, delay }) => (
  <div 
    ...
    style={{ animationDelay: delay }}
  >
    <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ${vertical ? 'w-[2px] h-full' : 'w-full h-[2px]'} bg-gradient-to-br from-indigo-200 to-blue-200`} />
...
export default function Workflows() {
  ...
  return (
    <main className="min-h-screen w-full font-display selection:bg-indigo-500/30 bg-[#faf9fc] relative overflow-hidden flex flex-col items-center">
      {/* Background Decor */}
      ...
      <div className="absolute bottom-[20%] left-[-10%] w-[600px] h-[600px] bg-blue-200/30 rounded-full blur-[100px] opacity-40 mix-blend-multiply pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-7xl px-6 lg:px-8 pt-6 lg:pt-8 pb-12 flex flex-col items-center">
        ...
        <div className="w-full max-w-3xl opacity-0 animate-[fade-in-up_0.8s_ease-out_forwards]" style={{ animationDelay: '1000ms' }}>
          <div className="bg-gradient-to-br from-indigo-600 to-blue-700 rounded-[2.5rem] p-10 lg:p-14 text-white shadow-[0_15px_50px_-12px_rgba(79,70,229,0.5)] flex flex-col items-center text-center relative overflow-hidden">
             ...
             <div className="relative z-10">
               ...
               <a
                 ...
                 className="inline-flex items-center gap-2 bg-white text-indigo-700 px-8 py-4 text-lg rounded-full font-bold hover:shadow-[0_10px_40px_-10px_rgba(255,255,255,0.5)] hover:bg-gray-50 hover:scale-105 active:scale-95 transition-all duration-300"
               >
