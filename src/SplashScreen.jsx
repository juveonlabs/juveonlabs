...
export default function SplashScreen({ onComplete }) {
  ...
  return (
    ...
    >
      {/* Ambient Glows */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-purple-600/15 rounded-full blur-[120px] animate-pulse" />
      <div className="absolute top-[30%] left-[20%] w-[300px] h-[300px] bg-indigo-500/10 rounded-full blur-[100px]" />
      <div className="absolute bottom-[20%] right-[15%] w-[350px] h-[350px] bg-purple-400/10 rounded-full blur-[100px]" />

      {/* Dotted Pattern */}
      <div className="absolute inset-0 opacity-[0.06]" style={{ backgroundImage: 'radial-gradient(#a855f7 1px, transparent 1px)', backgroundSize: '20px 20px' }} />
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        >
          <span className="text-3xl md:text-4xl font-bold tracking-tighter text-white font-display">
            juveon <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400">labs</span>
          </span>
        </div>
